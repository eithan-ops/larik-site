...
const CATEGORIES: { icon: string; name: string; ids: string[] }[] = [
  ...
  { icon: "⚡", name: "אקשן", ids: ["thieves", "colorrules", "pods", "demons"] },
...
const RECO_ORDER = ["impostor", "whomost", "alias", "wall", "hofrim", "thieves", "bombs", "colorrules", "trivia", "forehead", "demons", "simon", "pods", "deathtouch"];
