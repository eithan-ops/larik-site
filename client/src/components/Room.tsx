...
const CATEGORIES: { icon: string; name: string; ids: string[] }[] = [
  ...
  { icon: "⚡", name: "אקשן", ids: ["tanks", "floors", "thieves", "abyss", "colorrules", "pods", "demons"] },
...
const RECO_ORDER = ["impostor", "undercover", "whomost", "alias", "tanks", "floors", "wall", "hofrim", "thieves", "abyss", "bombs", "colorrules", "trivia", "forehead", "demons", "simon", "pods", "deathtouch"];
